...
class CreateProductPage extends StatefulWidget {
  ...
  @override
  CreateProductPageState createState() =>
      CreateProductPageState(type: type, standardEventId: standardEventId);
}
...
class CreateProductPageState extends State<CreateProductPage> {
  ...
  CreateProductPageState({required this.type, required this.standardEventId,});
    ...
    return SafeArea(
        child: Scaffold(
          appBar: appAppBar().getCustomAppBar(context,
              ...
              appBarTitle: AppLocalizations.of(context)!.translate("product_type"),
              onBackButtonPress: () {
