...
class CreateCompanyPage extends StatefulWidget {
  ...
  @override
  CreateCompanyPageState createState() =>
      CreateCompanyPageState(type: type, standardEventId: standardEventId);
}
...
class CreateCompanyPageState extends State<CreateCompanyPage> {
  ...
  CreateCompanyPageState({required this.type, required this.standardEventId,});
  ...
  void _showModalBottomSheet(BuildContext context) {
    showModalBottomSheet<void>(
      ...
      builder: (context) {
        return CreateCustomerBottomSheet(
          prefs: prefs,
