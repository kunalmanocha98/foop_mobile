...
import 'package:oho_works_app/crm_module/payment_mode_sheet.dart';
...
class UpdatePaymentSheet extends StatelessWidget {
  final Function(String value)? onClickCallback;
  final SharedPreferences? prefs;
  final isRoomsVisible;
  List<dynamic>? countryCodeList = [];
  UpdatePaymentSheet({this.onClickCallback,this.prefs,this.isRoomsVisible=true});
  @override
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: ListTile(
                    ...
                    Text(
                          "General Manager",
                          style: styleElements.bodyText2ThemeScalable(context).copyWith(color: HexColor(AppColors.appColorBlack35)),
                        ),
                        Text(
                          "Invoice Id:09888",
                          style: styleElements.subtitle1ThemeScalable(context).copyWith(fontWeight: FontWeight.bold),
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  labelText:
                                  AppLocalizations.of(context)!.translate("money_received"),),
