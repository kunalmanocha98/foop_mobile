      ...
      PopupMenuItem(
        ...
        child: Row(
          children: [
            ...
            Text(name=="P"?AppLocalizations.of(context)!.translate("Edit_Payment"):AppLocalizations.of(context)!.translate("edit"),
            ),
          ],
        ),
      ),
        ...
        PopupMenuItem(
          ...
          child: Row(
            children: [
              ...
              Text(AppLocalizations.of(context)!.translate("pay_bill"),
              ),
            ],
          ),
        ),
