...
class _GroupedListViewState<T, E> extends State<GroupedListView<T, E>> {
  ...
  Container _buildItem(context, int actualIndex) {
    ...
    bool isCurved=(actualIndex==0);
    bool isBottomCurved=(_sortedElements.length-1==actualIndex);
    return Container(
      margin: const EdgeInsets.only(left:8,right: 8),
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.only(
               topRight: isCurved? Radius.circular(10):Radius.circular(0),topLeft:isCurved? Radius.circular(10):Radius.circular(0)
            )),
