                  ...
                  children: [
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Container(
                          child: Text(
                          AppLocalizations.of(context)!.translate("set_pricing"),
                            textAlign: TextAlign.center,
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                                hintText: AppLocalizations.of(context)!.translate("max_price"),
                                                ...
                                                labelText:
                                                AppLocalizations.of(context)!.translate("max_price_enter"),),
                                      ...
                                      children: [
                                        Expanded(
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                                hintText: AppLocalizations.of(context)!.translate("min_price"),
                                                contentPadding: EdgeInsets.only(
                                                    left: 12, top: 16, bottom: 8),
                                                border: UnderlineInputBorder(
                                                    borderRadius:
                                                ...
                                                FloatingLabelBehavior.auto,
                                                labelText:
                                                AppLocalizations.of(context)!.translate("min_price_enter"),),
                    ...
                    children: [
                      Expanded(
                        ...
                        Padding(
                            ...
                            child: Text(AppLocalizations.of(context)!.translate("can_be_sold_min"))
                        ),
                      ),
