...
class OrderDetailPage extends StatefulWidget {
  ...
  OrderDetailPageState createState() =>
      OrderDetailPageState(type: type, standardEventId: standardEventId);
}
...
class OrderDetailPageState extends State<OrderDetailPage> {
  ...
  OrderDetailPageState({required this.type, required this.standardEventId,});
    ...
    return SafeArea(
        child: Scaffold(
          appBar: appAppBar().getCustomAppBar(context,
              ...
              centerTitle: false,
              appBarTitle: AppLocalizations.of(context)!.translate("detail_page_title")+(widget.selectedTab==1?AppLocalizations.of(context)!.translate("_order"):widget.selectedTab==0?AppLocalizations.of(context)!.translate("_opportunity"):AppLocalizations.of(context)!.translate("_invoice")),
              onBackButtonPress: () {
                          ...
                          children: [
                            ...
                            Text(
                              "₹ 209800"
                                  .toUpperCase(),
                              style: styleElements
                                  .headline4ThemeScalable(context)
                                  .copyWith(
                                  color: HexColor(AppColors.appColorBlack65)),
                            ),
