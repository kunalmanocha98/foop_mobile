...
TextStyle _progressTextStyle = TextStyle(
    color: HexColor(AppColors.appColorBlack), fontSize: 12.0, fontWeight: FontWeight.w400),
    _messageStyle = TextStyle(
        color: HexColor(AppColors.appColorBlack), fontSize: 18.0, fontWeight: FontWeight.w600);
