...
class SelectCompanyCategory extends StatefulWidget {
  bool isSignUp = false;

  _SelectCompanyCategory createState() => _SelectCompanyCategory();

  SelectCompanyCategory();
}

class _SelectCompanyCategory extends State<SelectCompanyCategory> {
    ...
    return
      SafeArea(child:  Scaffold(
        ...
        appBar: appAppBar().getCustomAppBar(context,
          appBarTitle: AppLocalizations.of(context)!.translate('entity_category'),
          onBackButtonPress: (){
