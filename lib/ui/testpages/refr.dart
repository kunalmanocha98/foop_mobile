...
class DFFFFFFF extends StatefulWidget {
  DFFFFFFF({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<DFFFFFFF> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text(
              AppLocalizations.of(context).translate('download_progress'),
            ),
            Text(
              '$_progress',
