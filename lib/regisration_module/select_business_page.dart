...
class SelectBusiness extends StatefulWidget {
  ...
  _SelectBusiness createState() =>
      _SelectBusiness(type, id, studentType, from, isInstituteSelectedAlready);
}

class _SelectBusiness extends State<SelectBusiness>
  ...
  _SelectBusiness(String type, int id, String studentType, String from,
      bool? isInstituteSelectedAlready) {
    this.type = type;
    this.id = id;
  ...
  Widget build(BuildContext context) {
    ...
    list = [];
    list.add(TabMaker(
      tabName: AppLocalizations.of(context)!.translate('select_business'),
...
//                                    visible: !listInstitute[index].isLoading,
    ...
    pageTitle = AppLocalizations.of(context)!.translate('select_business');
